...
namespace SpiralDocs.Models
{
    ...
    public partial class SearchResultObject
    {
        public static SearchResultObject FromJson(string json) => JsonConvert.DeserializeObject<SearchResultObject>(json, Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this SearchResultObject self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
